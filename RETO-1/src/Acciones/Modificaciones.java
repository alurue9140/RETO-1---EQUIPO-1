...
public class Modificaciones extends Acciones {

    public static Lector lector;
    public static Scanner input = new Scanner(System.in);

    public Modificaciones (Lector lector){
        ...
        for (int i = 0; i < lector.empleado.size(); i++) {
            ...
            if (ID == lector.empleado.get(i).getID()) {
                ...
                int opcion = MenuTerminal.leerEntero("\n------------------------------------------------------- \n" +
                                                             ...
                                                             "5.- Modificar Cuenta \n" +
                                                             "6.- Modificar Email \n" +
                                                             "7.- Modificar Datos.Departamento \n" +
                                                             "Volver atrás (0) \n" +
                                                             "Salir (-1) \n" +
                ...
                switch (opcion) {
                    ...
                    case 7:
                        int departamento = MenuTerminal.leerEntero("Introduce el nuevo número de Datos.Departamento del empleado con ID " + ID + ": ");
                        input.nextLine();
            ...
            for (int i = 0; i < lector.empleado.size(); i++) {
                ...
                if (ID == lector.empresa.get(i).getID()) {
                    ...
                    int opcion = MenuTerminal.leerEntero("\n------------------------------------------------------- \n" +
                                                                 ...
                                                                 "3.- Modificar Datos.Departamento \n" +
                                                                 "4.- Modificar Datos.Grupo de Cotización \n" +
                    ...
                    switch (opcion) {
                        ...
                        case 4:
                            int nuevoGrupo = MenuTerminal.leerEntero("Introduce el nuevo Datos.Grupo de cotización: ");
                            lector.empresa.get(i).setCodGrupo(nuevoGrupo);
                            System.out.println("------------------------------------------------------- \n" +
                                               "Los datos han sido modificados correctamente.");
                            System.out.println("Este es el nuevo Datos.Grupo de cotización: " + lector.empresa.get(i).getCodGrupo());
                            lector.guardar(lector);
                            datosEmpresariales(ID);
                            break;
